...
static void mdlOutputs(double *y, double *x, double *u, SimStruct *S, int tid)
{
  ...
  double a_KlaN2O, b_KlaN2O, D_N2, D_N2O , D_NO, D_O2, KlaN2O_anoxic, H_N2, H_N2O, H_NO, P_N2O_air, P_N2_air, P_NO_air;
...
////////////////////////////////////////////////////////
  ...
  KLa_temp = u[26]*pow(1.024, (u[15]-Temp_Ref));
...
double K_SO_AOBden1,  K_IO_AOBden1,  K_SO_AOBden2,  K_IO_AOBden2,  n_AOB,  n_Y_AOB;
...
proc7 =     k_h_Temp *((xtemp[3] /xtemp[4])/(K_X +(xtemp[3]/xtemp[4])))*((xtemp[7]/(K_OH1+xtemp[7]))+n_h*(K_OH1/(K_OH1+xtemp[7]))*(S_NOX/(K_NO3+S_NOX)))*xtemp[4];
proc8 =     proc7*xtemp[11]/xtemp[3];

proc9 =     mu_A1_Temp * xtemp[5] * (xtemp[16] / (K_SNO2_aob + xtemp[16])) * (xtemp[9] / (K_SNH_aob1 + xtemp[9])) * (xtemp[7]/(K_SO_AOBden1 + (1-2*pow((K_SO_AOBden1/K_IO_AOBden1),0.5)) * xtemp[7] + (pow(xtemp[7],2.0)/K_IO_AOBden1)));
proc10 =    mu_A1_Temp * xtemp[5] * (xtemp[17] / (K_SNO_aob +  xtemp[17])) * (xtemp[9] / (K_SNH_aob2 + xtemp[9])) * (xtemp[7]/(K_SO_AOBden2 + (1-2*pow((K_SO_AOBden2/K_IO_AOBden2),0.5)) * xtemp[7] + (pow(xtemp[7],2.0)/K_IO_AOBden2)));
...
/* XB */    reac5 = (1)*proc1 + (1)*proc2x1 + (1)*proc2x2 + (1)*proc2x3 + (1)*proc2x4 + (-1)*proc4;;
/* XBA1 */    reac6 =  proc3x1 + proc9 + proc10 - proc5x1 ;
...
/* SNNH */  reac10 = ( - i_X_B)*proc1 + ( - i_X_B)*proc2x1 + ( - i_X_B)*proc2x2 + ( - i_X_B)*proc2x3 + ( - i_X_B)*proc2x4 + ( - i_X_B - (1 / Y_A1))*proc3x1 + ( - i_X_B)*proc3x2 + (1) * proc6 + ( - (1.0 / (Y_A1*n_Y_AOB)) - i_X_B)*proc9 + ( - (1.0 / (Y_A1*n_Y_AOB)) - i_X_B)*proc10 ;
...
/* SNO2 */reac16 =  ((1 - Y_H * n_Y) / (1.14385714 * Y_H * n_Y))*proc2x1 + ( - (1 - Y_H * n_Y) / ((3.428571429 - 2.8571429) * Y_H * n_Y))*proc2x2 + (1 / Y_A1)*proc3x1 + ( - 1 / Y_A2)*proc3x2 + (- 1.0 / (Y_A1*n_Y_AOB))*proc9 + (1.0 / (Y_A1*n_Y_AOB))*proc10 ;
/* SNO */reac17 =  ((1 - Y_H * n_Y) / ((3.428571429 - 2.8571429) * Y_H * n_Y))*proc2x2 + ( - (1 - Y_H * n_Y) / ((3.428571429 - 2.8571429) * Y_H * n_Y))*proc2x3 + ( 2.0 / (Y_A1*n_Y_AOB))*proc9 + ( - 2.0 / (Y_A1*n_Y_AOB))*proc10;;
/* SN2O */reac18 =  ((1 - Y_H * n_Y) / ((3.428571429 - 2.8571429) * Y_H * n_Y))*proc2x3 + ( - (1 - Y_H * n_Y) / ((3.428571429 - 2.8571429) * Y_H * n_Y))*proc2x4 + ( 2.0 / (Y_A1*n_Y_AOB))*proc10;
/* SN2 */reac19 =  ((1 - Y_H * n_Y) / ((3.428571429 - 2.8571429) * Y_H * n_Y))*proc2x4;
