...
{
    ssSetNumContStates(    S, 160);   /* number of continuous states           van 80 naar 150*/
    ssSetNumDiscStates(    S, 0);   /* number of discrete states             */
    ssSetNumInputs(        S, 28);   /* number of inputs                      */
    ssSetNumOutputs(       S, 225);  /* number of outputs                     */
